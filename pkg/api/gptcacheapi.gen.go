...
type ServerInterface interface {
	...
	// (POST /forward)
	PostForward(ctx echo.Context) error
}
...
// PostForward converts echo context to params.
func (w *ServerInterfaceWrapper) PostForward(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostForward(ctx)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.POST(baseURL+"/forward", wrapper.PostForward)

...
type ServerInterface interface {
	// Forwards the post request unless a response for it is already in the cache.
	// (POST /forward)
	PostForward(w http.ResponseWriter, r *http.Request)
}
...
// Forwards the post request unless a response for it is already in the cache.
// (POST /forward)
func (_ Unimplemented) PostForward(w http.ResponseWriter, r *http.Request) {
...
// PostForward operation middleware
func (siw *ServerInterfaceWrapper) PostForward(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PostForward(w, r)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/forward", wrapper.PostForward)
	})
